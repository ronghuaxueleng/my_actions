 ...
 * @Date: 2021-07-01 21:13:43
 * @LastEditors: 明月寒
 * @LastEditTime: 2021-07-01 21:35:47
 * @Description:
 */
/*
京喜财富岛
根据github@MoPoQAQ 财富岛脚本修改而来。无需京喜token,只需京东cookie即可.
cron 5 14 * * * jx_cfd_lottery.js
更新时间：2021-6-9
...
[task_local]
#京喜财富岛-娱乐中心-抽奖
5 14 * * * jx_cfd_lottery.js, tag=京喜财富岛-娱乐中心-抽奖, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
      ...
      var i = t,
        ...
        d = (a.DES = s.extend({
          ...
          _doCryptBlock: function (t, i, n) {
            ...
            for (var o = 0; o < 16; o++) {
              for (
                var s = n[o], a = this._lBlock, c = this._rBlock, h = 0, l = 0;
                l < 8;
                l++
              )
                h |= f[l][((c ^ s[l]) & u[l]) >>> 0];
      ...
      async (err, resp, data) => {
        try {
          if (err) {
            ...
            // if(dwFreeCount == 1) {
            if (dwDayRemainCount > 0) {
              for (let c = 0; c < dwDayRemainCount; c++) {
                await $.wait(3000);
      ...
      async (err, resp, data) => {
        try {
          if (err) {
            ...
            const { iRet, sErrMsg, strBingoDescr, strPrizeName } =
              JSON.parse(data);
            $.log(`${strBingoDescr}\n${strPrizeName}`);

            $.log(
              `\n【抽奖结果】🎰 ${
                strPrizeName == "" ? "未中奖" : strPrizeName
              } \n${$.showLog ? data : ""}`
            );
          }
        } catch (e) {
...
function taskUrl(function_path, body) {
  ...
  url += `&h5st=${decrypt(Date.now(), "", "", url)}&_=${
    Date.now() + 2
  }&sceneval=2&g_login_type=1&g_ty=ls`;
  return {
    url,
    headers: {
      Cookie: cookie,
...
var _0xod8 = "jsjiami.com.v6",
  _0x2cf9 = [
    ...
    "SsOTGQU0",
    "w5fDtsOZw7rDhnHDpgo=",
    "w47DoV4CZsK7w6bDtAkyJsOJexNawqZnw6FTe0dQw63DlHlvGMKBw4rDs8OYwoEWD0ML",
    "VRFwZ8KG",
    "H2jCkCrDjw==",
    "bMO0Nigr",
    "w5fDlkwEZg==",
    ...
    "w5vDrG4SccK0w6/Duw==",
    "w6HClVzDiX8=",
    "5q2P6La95Y6CEiDCkMOgwrcr5aOj5Yes5LqV6Kai6I6aauS/jeebg1YLw5RSGy7Cm3M9QuWSlOmdsuazmOWKleWPs0PDkcOgPg==",
    "WjsjIieSanSTdXmiuZb.EncDom.v6==",
  ];
(function (_0x30e78a, _0x12a1c3, _0x4ca71c) {
  var _0x40a26e = function (
    _0x59c439,
    _0x435a06,
    _0x70e6be,
    _0x39d363,
    ...
    if (_0x435a06 < _0x59c439) {
      while (--_0x59c439) {
        ...
        if (_0x435a06 === _0x59c439) {
          ...
          _0x435a06 &&
          _0x70e6be["replace"](/[WIeSnSTdXuZbEnD=]/g, "") === _0x435a06
        ) {
...
var _0x5108 = function (_0x4dc255, _0x3cb8bc) {
  ...
  if (_0x5108["xFLNEr"] === undefined) {
    (function () {
      ...
      _0xfc2aa4["atob"] ||
        (_0xfc2aa4["atob"] = function (_0x509ed4) {
          ...
          for (
            var _0x5f2c3c = 0x0,
              ...
              _0x50b6c7 = 0x0,
              _0x2de292 = "";
            (_0x42fadc = _0x2e5ed8["charAt"](_0x50b6c7++));
            ~_0x42fadc &&
            ((_0x5a7e73 =
              _0x5f2c3c % 0x4 ? _0x5a7e73 * 0x40 + _0x42fadc : _0x42fadc),
            _0x5f2c3c++ % 0x4)
              ? (_0x2de292 += String["fromCharCode"](
                  0xff & (_0x5a7e73 >> ((-0x2 * _0x5f2c3c) & 0x6))
                ))
              : 0x0
          ) {
    ...
    var _0x503f7f = function (_0x517424, _0x3cb8bc) {
      ...
      for (
        var _0x2212a4 = 0x0, _0x34e1ad = _0x517424["length"];
        _0x2212a4 < _0x34e1ad;
        _0x2212a4++
      ) {
        _0x19ba11 +=
          "%" +
          ("00" + _0x517424["charCodeAt"](_0x2212a4)["toString"](0x10))[
            "slice"
          ](-0x2);
      }
      ...
      for (_0x5372ab = 0x0; _0x5372ab < 0x100; _0x5372ab++) {
        _0x204abf =
          (_0x204abf +
            _0x5bb1d7[_0x5372ab] +
            _0x3cb8bc["charCodeAt"](_0x5372ab % _0x3cb8bc["length"])) %
          0x100;
      ...
      for (var _0x30875f = 0x0; _0x30875f < _0x517424["length"]; _0x30875f++) {
        ...
        _0x5bb1d7[_0x5372ab] = _0x5bb1d7[_0x204abf];
        _0x5bb1d7[_0x204abf] = _0x50c70e;
        _0x376d53 += String["fromCharCode"](
          _0x517424["charCodeAt"](_0x30875f) ^
            _0x5bb1d7[(_0x5bb1d7[_0x5372ab] + _0x5bb1d7[_0x204abf]) % 0x100]
        );
      }
      return _0x376d53;
    };
...
function getJxToken() {
  ...
  function _0x23cb77(_0x378208) {
    ...
    for (
      let _0x24b162 = 0x0;
      _0x3565bd[_0x5108("2", "1#C#")](_0x24b162, _0x378208);
      _0x24b162++
    ) {
      _0x3ba0b7 +=
        _0x36ad34[
          _0x3565bd[_0x5108("3", "Hq%O")](
            parseInt,
            _0x3565bd[_0x5108("4", "U*Pv")](
              Math["random"](),
              _0x36ad34[_0x5108("5", "8QnT")]
            )
          )
        ];
    }
