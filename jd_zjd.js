            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4:
                        shareCode = user.index === 0 ? Array.from(new Set(__spreadArray(__spreadArray([], __read(shareCodeHW), false), __read(shareCodeSelf), false))) : Array.from(new Set(__spreadArray(__spreadArray([], __read(shareCodeSelf), false), __read(shareCodeHW), false)));
                        return [4 /*yield*/, this.getFp()];
                    case 5:
                        fp = _c.sent();
