...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookiesArr, t, fn, body, params, key, data, _a, _b, t_1, e_1_1;
    var e_1, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                console.log("<Start> ".concat(UserName, "\n"));
            ...
            case 3:
                ...
                _a = __values(data.data.gears), _b = _a.next();
                _d.label = 4;
            case 4:
                if (!!_b.done) return [3 /*break*/, 7];
                t_1 = _b.value;
                console.log(t_1.amount);
                if (!(t_1.amount === '50' || t_1.amount === '120')) return [3 /*break*/, 6];
