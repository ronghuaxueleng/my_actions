...
# 签到领现金_Windfgg
30 8,14 * * * node /scripts/jd_cash_jddepot_windfg.js >> /scripts/logs/jd_cash_jddepot_windfg.log 2>&1
# 微信签到领现金
16 0,5 * * * node /scripts/jd_cash_jddepot_wx.js >> /scripts/logs/jd_cash_jddepot_wx.log 2>&1
# 京喜财富岛
1 0-23/2 * * * node /scripts/jd_cfd_jddepot.js >> /scripts/logs/jd_cfd_jddepot.log 2>&1
# 财富岛互助
33 0,14 * * * node /scripts/jd_cfd_jddepot_help.js >> /scripts/logs/jd_cfd_jddepot_help.log 2>&1
# 清空购物车
...
# 京喜工厂
10 0,6-23 * * * node /scripts/jd_dreamFactory_jddepot.js >> /scripts/logs/jd_dreamFactory_jddepot.log 2>&1
# 京喜工厂招工互助
5 6,18 * * * node /scripts/jd_dreamFactory_jddepot_help.js >> /scripts/logs/jd_dreamFactory_jddepot_help.log 2>&1
# 京喜工厂开团
40 0,8 * * * node /scripts/jd_dreamFactory_jddepot_tuan.js >> /scripts/logs/jd_dreamFactory_jddepot_tuan.log 2>&1
# M京豆夺宝
...
# 东东农场好友删减奖励
10 2 * * * node /scripts/jd_fruit_jddepot_friend.js >> /scripts/logs/jd_fruit_jddepot_friend.log 2>&1
# 东东农场内部水滴互助
20 4,16 * * * node /scripts/jd_fruit_jddepot_help.js >> /scripts/logs/jd_fruit_jddepot_help.log 2>&1
# 东东农场日常任务
5 6-18/6 * * * node /scripts/jd_fruit_jddepot_task.js >> /scripts/logs/jd_fruit_jddepot_task.log 2>&1
# 金榜创造营
13 1,22 * * * node /scripts/jd_gold_creator.js >> /scripts/logs/jd_gold_creator.log 2>&1
# 东东健康社区
13 1,6,22 * * * node /scripts/jd_health_jddepot.js >> /scripts/logs/jd_health_jddepot.log 2>&1
# 东东健康社区收集能量收集
5-45/20 * * * * node /scripts/jd_health_jddepot_collect.js >> /scripts/logs/jd_health_jddepot_collect.log 2>&1
# 东东健康社区内部互助
5 4,14 * * * node /scripts/jd_health_jddepot_help.js >> /scripts/logs/jd_health_jddepot_help.log 2>&1
# 京洞察问卷通知
...
# 东东工厂
10 0,6-23 * * * node /scripts/jd_jdfactory_jddepot.js >> /scripts/logs/jd_jdfactory_jddepot.log 2>&1
# 东东工厂内部互助
50 4,17 * * * node /scripts/jd_jdfactory_jddepot_help.js >> /scripts/logs/jd_jdfactory_jddepot_help.log 2>&1
# 京东赚赚修复版
...
# 京喜牧场
20 0-23/2 * * * node /scripts/jd_jxmc_jddepot.js >> /scripts/logs/jd_jxmc_jddepot.log 2>&1
# 惊喜牧场内部互助
23 0-23/3 * * * node /scripts/jd_jxmc_jddepot_hb.js >> /scripts/logs/jd_jxmc_jddepot_hb.log 2>&1
# 砍价免费拿
...
# 东东萌宠
15 6-18/6 * * * node /scripts/jd_pet_jddepot.js >> /scripts/logs/jd_pet_jddepot.log 2>&1
# 东东萌宠内部互助
30 5,20 * * * node /scripts/jd_pet_jddepot_help.js >> /scripts/logs/jd_pet_jddepot_help.log 2>&1
# 种豆得豆
1 7-21/2 * * * node /scripts/jd_plantBean_jddepot.js >> /scripts/logs/jd_plantBean_jddepot.log 2>&1
# 种豆得豆内部互助
40 4,17 * * * node /scripts/jd_plantBean_jddepot_help.js >> /scripts/logs/jd_plantBean_jddepot_help.log 2>&1
# 京东保价
...
# 闪购盲盒
20 8 * * * node /scripts/jd_sgmh_jddepot.js >> /scripts/logs/jd_sgmh_jddepot.log 2>&1
# 闪购签到有礼
