...
# 东东农场日常任务
5 6-18/6 * * * node /scripts/jd_fruit_ShuaiLeiLu.js >> /scripts/logs/jd_fruit_ShuaiLeiLu.log 2>&1
# 东东农场好友删减奖励
10 2 * * * node /scripts/jd_fruit_ShuaiLeiLu_friend.js >> /scripts/logs/jd_fruit_ShuaiLeiLu_friend.log 2>&1
# 东东农场好友删减奖励
20 4,16 * * * node /scripts/jd_fruit_ShuaiLeiLu_help.js >> /scripts/logs/jd_fruit_ShuaiLeiLu_help.log 2>&1
# 通用游戏任务
