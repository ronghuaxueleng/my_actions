...
function updateTuanIdsCDN(url = 'https://raw.fastgit.org/ElsaKing/updateTeam/b5727adcca53368eab0600c957d208e523927c89/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
