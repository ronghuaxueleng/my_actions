...
海尔开盒有礼
作者：unknown
活动时间：2021-7-5至2021-7-11
活动入口：京东app-海尔京东自营旗舰店-0元赢大礼
...
============小火箭=========
海尔开盒有礼 = type=cron,script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_khyl.js, cronexpr="40 1,23 * * *", timeout=3600, enable=true

*/

const $ = new Env('海尔开盒有礼');
...
!(async () => {
  ...
  console.log('海尔开盒有礼\n' +
      '活动时间：2021-7-5至2021-7-11\n' +
      '活动入口：京东app-海尔京东自营旗舰店-0元赢大礼\n' +
      '活动地址：https://anmp.jd.com/babelDiy/Zeus/2e6SGdSEVmY18TSBeu7ewRKHmp22/index.html?wxAppName=jd');
...
function getInfo(url = 'https://anmp.jd.com/babelDiy/Zeus/2e6SGdSEVmY18TSBeu7ewRKHmp22/index.html?wxAppName=jd') {
  console.log(`url:${url}`)
  return new Promise(resolve => {
    $.get({
      url,
...
function taskUrl(function_id, body = '') {
  ...
  return {
    ...
    headers: {
      ...
      'Referer': `https://anmp.jd.com/babelDiy/Zeus/2e6SGdSEVmY18TSBeu7ewRKHmp22/index.html?wxAppName=jd`,
      'Cookie': cookie
    }
  }
}
