...
[task_local]
#超级直播间红包雨
0,30 0-23/1 * * * jd_redrain.js, tag=超级直播间红包雨, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "0,30 0-23/1 * * *" script-path=jd_redrain.js,tag=超级直播间红包雨
================Surge===============
超级直播间红包雨 = type=cron,cronexp="0,30 0-23/1 * * *",wake-system=1,timeout=3600,script-path=jd_redrain.js
===============小火箭==========
超级直播间红包雨 = type=cron,script-path=jd_redrain.js, cronexpr="0,30 0-23/1 * * *", timeout=3600, enable=true
*/
